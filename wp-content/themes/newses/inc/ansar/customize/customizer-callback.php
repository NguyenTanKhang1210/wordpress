...
/*select page for newses_header_status news*/
if (!function_exists('newses_header_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_header_status($control)
    {
...
/*select page for slider*/
if (!function_exists('newses_main_navigation_background_color_mode_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_main_navigation_background_color_mode_status($control)
    {
...
/*select page for slider*/
if (!function_exists('newses_global_site_mode_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_global_site_mode_status($control)
    {
    ...
    /*select page for slider*/
if (!function_exists('newses_global_site_mode_dark_light_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_global_site_mode_dark_light_status($control)
    {
...
/*select page for slider*/
if (!function_exists('newses_banner_mode_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_banner_mode_status($control)
    {
...
/*select page for slider*/
if (!function_exists('newses_featured_product_section_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_featured_product_section_status($control)
    {
...
if (!function_exists('newses_frontpage_content_alignment_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_frontpage_content_alignment_status($control)
    {
...
/*select page for slider*/
if (!function_exists('newses_latest_news_section_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_latest_news_section_status($control)
    {
...
/*select page for slider*/
if (!function_exists('newses_archive_image_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function newses_archive_image_status($control)
    {
